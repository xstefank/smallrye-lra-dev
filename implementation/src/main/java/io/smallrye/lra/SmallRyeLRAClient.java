...
import io.smallrye.lra.logging.LRALogger;
 ...
 */
@RequestScoped
public class SmallRyeLRAClient implements LRAClient, Closeable {
     ...
     */
    public SmallRyeLRAClient() throws URISyntaxException {
     ...
     */
    public SmallRyeLRAClient(String host, int port) throws URISyntaxException {
        this("http", host, port);
    }
     ...
     * @param port  port where the LRA coordinator will be contacted
     */
    public SmallRyeLRAClient(String scheme, String host, int port) throws URISyntaxException {
     ...
     */
    public SmallRyeLRAClient(URL coordinatorUrl) throws MalformedURLException, URISyntaxException {
        init(coordinatorUrl);
    }
    ...
    public String joinLRA(URL lraId, Class<?> resourceClass, URI baseUri,
        ...
        String timeLimitStr = terminateURIs.get(SmallRyeLRAClient.TIMELIMIT_PARAM_NAME);
        long timeLimit = timeLimitStr == null ? SmallRyeLRAClient.DEFAULT_TIMEOUT_MILLIS : Long.valueOf(timeLimitStr);
    ...
    private LRAInfo toLRAInfo(JsonObject jo) {
        try {
            ...
            return new SmallRyeLRAInfo("JSON Parse Error: " + e.getMessage(),
                    e.getMessage(),
                    "Unknown",
    ...
    private String enlistCompensator(URL lraUrl, long timelimit, String uriPrefix,
        ...
        terminateURIs.put(SmallRyeLRAClient.COMPENSATE, compensateUrl);
        terminateURIs.put(SmallRyeLRAClient.COMPLETE, completeUrl);
        terminateURIs.put(SmallRyeLRAClient.LEAVE, leaveUrl);
        terminateURIs.put(SmallRyeLRAClient.STATUS, statusUrl);
        terminateURIs.put(SmallRyeLRAClient.FORGET, forgetUrl);
